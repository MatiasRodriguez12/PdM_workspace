...
//Mensajes a enviar por UART - Indican la deteccion de pulsaciones/liberacion del boton.
static uint8_t flancoDesc[]="Flanco descendente detectado\n\r";
static uint8_t flancoAsc[]="Flanco ascendente detectado\n\r";
